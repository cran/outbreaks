...
#'
#' These data describe the daily incidence of Zika virus disease in San Andres,
#' Colombia.
#'
#' @docType data
#'
...
#' cover the period from September 2015 to January 2016, over which time a total
#' of 928 cases were reported to health authorities of San Andres (population of
#' 54,513). Suspected cases were confirmed by reverse transcription-polymerase
#' chain reaction (RT-PCR) in the serum of acute cases within five days of
#' symptom onset.
#'
#' }
#' @rdname zika_sanandres_2015
#'
